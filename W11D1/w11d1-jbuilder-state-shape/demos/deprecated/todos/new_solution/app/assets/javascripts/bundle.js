...
var _step_api_util = __webpack_require__(/*! ../util/step_api_util */ "./frontend/util/step_api_util.js");
...
var _error_actions = __webpack_require__(/*! ./error_actions */ "./frontend/actions/error_actions.js");
...
// sync actions
var receiveTodos = exports.receiveTodos = function receiveTodos(payload) {
  return {
    type: RECEIVE_TODOS,
    payload: payload
  };
...
var receiveTodo = exports.receiveTodo = function receiveTodo(payload) {
  return {
    type: RECEIVE_TODO,
    payload: payload
  };
...
var _step_list_item_container = __webpack_require__(/*! ./step_list_item_container */ "./frontend/components/step_list/step_list_item_container.jsx");
...
var _step_list_container = __webpack_require__(/*! ../step_list/step_list_container */ "./frontend/components/step_list/step_list_container.jsx");
...
// Actions
var selectTagIds = function selectTagIds(state, id) {
  return Object.values(state.taggings).filter(function (tagging) {
    return tagging.todo_id === id;
  }).map(function (tagging) {
    return state.tags[tagging.tag_id];
  });
};
...
var mStP = function mStP(state, _ref) {
  ...
  var tags = selectTagIds(state, todo.id);
...
exports.default = (0, _reactRedux.connect)(mStP, // todo props is already passed in
...
var _error_list = __webpack_require__(/*! ./error_list */ "./frontend/components/todo_list/error_list.jsx");
...
var _todo_detail_view_container = __webpack_require__(/*! ./todo_detail_view_container */ "./frontend/components/todo_list/todo_detail_view_container.jsx");
...
var _error_actions = __webpack_require__(/*! ../actions/error_actions */ "./frontend/actions/error_actions.js");
...
var _taggings_reducer = __webpack_require__(/*! ./taggings_reducer */ "./frontend/reducers/taggings_reducer.js");

var _taggings_reducer2 = _interopRequireDefault(_taggings_reducer);
...
var rootReducer = (0, _redux.combineReducers)({
  ...
  taggings: _taggings_reducer2.default
});
...
var taggingReducer = function taggingReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments[1];
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      return (0, _merge2.default)({}, state, action.payload.taggings);
    default:
      return state;
  }
};

exports.default = taggingReducer;
...
var tagsReducer = function tagsReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      return (0, _merge2.default)({}, state, action.payload.tags);
    default:
      return state;
  }
};
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODO:
      ...
      return (0, _merge2.default)({}, state, action.payload.todo);
...
var configureStore = function configureStore() {
  ...
  return (0, _redux.createStore)(_root_reducer2.default, preloadedState, (0, _redux.applyMiddleware)(_thunk_middleware2.default, _reduxLogger2.default));
};
